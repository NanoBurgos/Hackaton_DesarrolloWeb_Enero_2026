...
•	Los usuarios se validan contra una base de datos SQLite (negocios.db).
...
Este proyecto demuestra cómo construir un MVP profesional, seguro y escalable para hackathons, aplicando buenas prácticas reales de desarrollo backend sin complejidad innecesaria.
________________________________________
